...
public class LoginController {
    ...
    private static final String UPLOAD_DIR = "D:\\d_code\\git\\软件工程\\Project\\code\\demo\\src\\main\\resources\\static\\posts_photos";
    ...
    public String uploadAvatar(@RequestPart("avatar") MultipartFile avatar,
        ...
        if (user != null && !avatar.isEmpty()) {
            ...
            String uploadDir = ("D:\\d_code\\git\\软件工程\\Project\\code\\demo\\src\\main\\resources\\static\\avatar").toString();
