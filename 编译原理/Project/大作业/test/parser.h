...
// 解析辅助函数 parseHelper
string parseHelper(EnglishParserBrain& b, const string& sentence, float p, int LEX_k, int project_rounds, bool verbose, bool debug,
...
// 解析函数 parse
string parse(const std::string& sentence = "big people bite the big dogs quickly", const std::string& language = "English",
