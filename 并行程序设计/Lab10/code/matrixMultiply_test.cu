...
int main() {
    ...
    // 调用Kernel函数进行矩阵乘法运算
    matrixMultiply_global<<<numBlocks, threadsPerBlock>>>(d_A, d_B, d_C, N);
    ...
    printf("Kernel for matrixMultiply_global:\n");
    ...
    */
    // 输出计算时间
    printf("\nTime for computing C(global): %.2f ms\n", milliseconds);
    printf("---------------------------\n");
    ...
    printf("Kernel for matrixMultiply_shared:\n");
    printf("  Block dimensions: (%d, %d)\n", threadsPerBlock.x, threadsPerBlock.y);
    printf("  Grid dimensions: (%d, %d)\n", numBlocks.x, numBlocks.y);
    ...
    */
    // 输出计算时间
    printf("\nTime for computing C(shared): %.2f ms\n", milliseconds);
    printf("---------------------------\n");
    printf("-------------------------------------------------------\n");
